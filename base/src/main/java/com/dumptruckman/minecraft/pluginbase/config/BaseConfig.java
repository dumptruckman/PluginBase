...
public interface BaseConfig extends Properties {
    ...
    SimpleEntry<Locale> LOCALE = new EntryBuilder<Locale>(Locale.class, "settings.language.locale").def(Locale.ENGLISH)
     ...
     * Locale name config path, default and comments.
     */
    SimpleEntry<String> LANGUAGE_FILE = new EntryBuilder<String>(String.class, "settings.language.file")
     ...
     */
    SimpleEntry<Integer> DEBUG_MODE = new EntryBuilder<Integer>(Integer.class, "settings.debug_level").def(0)
     ...
     */
    SimpleEntry<Boolean> FIRST_RUN = new EntryBuilder<Boolean>(Boolean.class, "settings.first_run").def(true)

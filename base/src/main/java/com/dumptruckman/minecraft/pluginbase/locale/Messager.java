...
public interface Messager extends MessageProvider {
     ...
     */
    void message(BasePlayer sender, Message message, Object... args);
     ...
     * @param message The message to send.
     */
    void message(BasePlayer sender, BundledMessage message);
     ...
     */
    void message(BasePlayer player, List<String> messages);

    void messageAndLog(BasePlayer sender, Message message, Object... args);
}

...
public class MessageTest {
    ...
    enum TestEnumMessages implements LocalizablePlugin {
    ...
    public void testEnumMessages() throws Exception {
        ...
        Assert.assertNotNull(Messages.getMessage(TestEnumMessages.IN_GAME_ONLY, TestEnumMessages.INVALID_AMOUNT.getMessage().getKey()));
        MessageProvider provider = Messages.loadMessages(TestEnumMessages.IN_GAME_ONLY,
                ...
                Locale.ENGLISH);
        Assert.assertEquals(TestEnumMessages.IN_GAME_ONLY.getMessage().getDefault(), provider.getLocalizedMessage(TestEnumMessages.IN_GAME_ONLY.getMessage()));
    }

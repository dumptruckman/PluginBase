...
public interface Messager extends MessageProvider {
     ...
     */
    void bad(Messages message, CommandSender sender, Object... args);
     ...
     * @param args    arguments for String.format().
     */
    void normal(Messages message, CommandSender sender, Object... args);
     ...
     * @param args    arguments for String.format().
     */
    void good(Messages message, CommandSender sender, Object... args);
     ...
     * @param args    arguments for String.format().
     */
    void info(Messages message, CommandSender sender, Object... args);
     ...
     * @param args    arguments for String.format().
     */
    void help(Messages message, CommandSender sender, Object... args);
